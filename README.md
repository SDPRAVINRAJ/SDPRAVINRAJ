...
|--|--|
   | :books: |<p>High School :<pre>SMK Dato' Zulkiffli Muhammad</p></pre><p>College :<pre> Perak Matriculation College</pre></p> <p>University :<pre> University Technology Malaysia </pre>|
| sport🏅:|badminton and cycling|
