...
|----------|-------------|-------------|------------|
| 🇧🇷 Brazilian Education Census ETL Pipeline | Apache Spark, PySpark, PostgreSQL, Docker, Metabase | Processed ~2.2GB census dataset, transformed raw CSV files into optimized Parquet format, and built a Star Schema warehouse for analytics and reporting | 🔗 [View Repository](https://github.com/SDPRAVINRAJ/brazilian-school-census-etl-pipeline) |
